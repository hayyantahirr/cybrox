    ...
    <MouseEffect>
      <section className="relative min-h-[85vh] flex items-center justify-center px-6 py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          {/* Main Heading */}
          <h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center mb-8 text-[#F4EAD4] leading-tight animate-slide-up"
          ...
          {/* Description */}
          <p className="text-lg sm:text-xl md:text-2xl text-center text-[#F4EAD4]/80 max-w-4xl mx-auto mb-12 leading-relaxed font-light animate-fade-in delay-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-16 animate-scale-in delay-700">
            {/* Stat 1 */}
            <div className="text-center p-6 rounded-2xl bg-[#cfcfce] backdrop-blur-sm border border-[#1b1b1b]/10 hover:border-[#1F6F50]/30 transition-all duration-300 hover:scale-105">
              <div
                className="text-4xl md:text-5xl font-bold text-[#2e8b57] mb-2"
                style={{ fontFamily: "Nippo, sans-serif" }}
              >
                500+
              </div>
