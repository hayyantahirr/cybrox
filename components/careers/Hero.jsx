...
const Hero = () => {
  return (
    <section className="relative  bg-linear-to-br from-[#f4eade] to-white">
      <MouseEffect>
        <div className="max-w-4xl mx-auto text-center py-24 md:py-36 px-6">
          <h1
          ...
          <p className="text-lg md:text-xl text-[#1b1b1b] mb-6 font-light leading-relaxed animate-fade-in">
            Be part of something extraordinary. At Cybrox, we're crafting
            digital experiences that transform businesses and looking for
