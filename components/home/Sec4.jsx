export default function Sec4() {
  const socialPlatforms = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
          <path d="M11.566 21.563v-8.762c0-.255-.17-.425-.424-.425H9.614c-.255 0-.425.17-.425.425v8.762c0 .255.17.425.425.425h1.528c.255 0 .424-.17.424-.425zm.424-12.606c0-1.188-.933-2.145-2.145-2.145-1.188 0-2.145.933-2.145 2.145 0 1.188.933 2.145 2.145 2.145 1.188 0 2.145-.933 2.145-2.145zm4.461-4.291c-.424-.17-.848-.255-1.273-.255-2.145 0-3.927 1.697-3.927 3.927v.424c0 .255.17.425.425.425h1.527c.255 0 .425-.17.425-.425v-.424c0-.933.764-1.697 1.697-1.697.255 0 .509.085.764.17.255.085.509-.085.594-.34l.509-1.273c.085-.255-.085-.509-.34-.594-.255-.085-.255-.085-.401-.085z" />
        </svg>
      ),
      handle: "@cybrox",
      followers: "1K+ Connections",
      engagement: "20+ Posts",
      color: "from-[#2164F3] to-[#1A4FBF]",
